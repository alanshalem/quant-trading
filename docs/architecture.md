...
| `accelerator/02_classical_strategies/`      | **Vectorized (no ML)** — pandas momentum + mean reversion with fees |
| `accelerator/03_ml_strategy/`               | **Vectorized** — log returns, PyTorch, `learn_model_trades` |
| `accelerator/04_event_driven_strategies/`   | **Event-driven** — `CCXTLoader`, `EnvelopeStrategy`, `BacktestAnalysis` |
